...
import pages_PF.DemoPage2_PF;

public class ExecuteTests2_PF {

	static WebDriver driver;
	static Properties prop1;
	static DemoPage2_PF dmp2;

	@Test(priority = 0)
	public void Test_PageUrl() {
		driver = ExecuteTests_PF.driver;
		prop1 = ExecuteTests_PF.prop1;
		dmp2 = new DemoPage2_PF(driver, prop1);
		dmp2.verifyPageUrl();
	}
